angular.module("jqmAdapter", ["ng", "ngRoute"]);
...
(function(factory) {
     ...
     */
    (function ($, angular) {
        var ng = angular.module("jqmAdapter");
    ...
    (function ($, angular) {
        ...
        var mod = angular.module("jqmAdapter");
        ...
        function registerBrowserDecorator($provide) {
            ...
            $provide.decorator('$browser', ['$delegate', '$history', '$injector', browserHistoryDecorator]);
            ...
            function browserHistoryDecorator($browser, $history, $injector) {
                var _url = $browser.url,
