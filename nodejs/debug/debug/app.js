 ...
 */
module.factory('stateManager', ['socket', '$timeout', function(socket, $timeout) {
...
module.controller('MainCtrl', ['$scope', 'socket', '$timeout', 'stateManager', function($scope, socket, $timeout, stateManager) {
